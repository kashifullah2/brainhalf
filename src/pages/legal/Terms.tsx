...
export default function TermsOfService() {
  return (
    <LegalLayout title="Terms of Service" canonicalPath="/terms">
      ...
      <p>Due to the nature of Artificial Intelligence (BH Models), we cannot guarantee 100% accuracy of the extracted text. You are responsible for verifying the output before utilizing it in production environments.</p>
