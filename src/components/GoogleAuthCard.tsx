          ...
          <div className="w-full flex flex-col gap-3 items-center justify-center">
            {clientId ? (
              ...
              <Button
                ...
                className="relative w-full h-11 rounded-xl border-border/80 bg-card hover:bg-muted/50 text-foreground font-bold text-sm shadow-sm hover:shadow transition-all flex items-center justify-center gap-3 group border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
              >
                ...
                <ArrowRight className="w-4 h-4 ml-auto text-muted-foreground group-hover:translate-x-0.5 group-hover:text-primary transition-all" />
              </Button>
            )}
          </div>
        </div>
